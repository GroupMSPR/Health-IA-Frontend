        ...
        <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
                ...
                <section className="space-y-4 sm:space-y-6 flex flex-col justify-between" aria-labelledby="actions-heading">
                    ...
                    <Link to="/scan" className="flex-1 bg-gradient-to-br from-[#4A6BF0] to-[#7B3FF2] p-6 rounded-3xl shadow-lg hover:shadow-xl transition-all group relative overflow-hidden flex items-center gap-4">
